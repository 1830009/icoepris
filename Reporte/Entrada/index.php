<?php
function pdfEntrada($tabla,$id_tbl){
    //require '/icoepris/login/sesion.php'; 
    include('extra.php');
...
$pdf->SetFont('Arial','',12);
$pdf->MultiCell(0, 6, 'Por este conducto recibó el siguiente material de, '.$_POST['recibe'].' , añadiendo los siguientes productos al departamento correspondiente.',0,'',false);
$pdf->Ln(8);
...
if($res->num_rows>0){
    ...
    $pdf ->Ln(12);
    $pdf->SetFont('Arial','b',10);
    $pdf -> Cell(190, 10, 'Proveedor:', 0, 1, 'C', 0);
    $pdf->SetFont('Arial','',10);
    $pdf ->Ln(8);
