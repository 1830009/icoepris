    ...
    $conexion=ConectarBD();
        if(!$conexion){
            ...
            if(isset($_POST['nombre'])){
                $query= 'UPDATE `proyecto_federal` SET `codigo`="'.$_POST['codigo'].'",`nombre`="'.$_POST['nombre'].
                '",`unidad`="'.$_POST['unidad'].'",`marca`="'.$_POST['marca'].'",`color`="'.$_POST['color'].'" WHERE id_federal='.$_POST['id'];
        ...
        if(isset($_GET['x'])){    
            $query= 'SELECT * FROM proyecto_federal WHERE id_federal='.$_GET['x'];
        ...
        <h1 class="titulo_usuario">Actualizar producto:</h1>
            <div class="flex">
                ...
                <div class="contenido1">
                    <input type="hidden" name="id" value="<?php echo $fila['id_federal']?>">
